...
Serial.begin(9600);
mySerial.begin(9600); // Changed from 9600 to 115200
...
if((((map(XSum/100, XMin, XMax, -1000, 1000)))>2000) && (((map(YSum/100, YMin, YMax, -1000,
1000)))>2000) && (((map(ZSum/100, ZMin, ZMax, -1000, 1000)))>2000))
